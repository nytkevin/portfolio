...
export default function Contact() {
  ...
  return (
    <section id="contact" className=" py-15 pb-30">
          ...
          <div className="flex gap-6">
            {socialLinks.map((link) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-cyan-400 transition duration-300 text-sm font-medium hover:shadow-lg hover:shadow-cyan-400/50 underline"
              >
                {link.name}
              </a>
            ))}
